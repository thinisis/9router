...
import { Card, Button, ModelSelectModal, ManualConfigModal, ToolSetupAlert } from "@/shared/components";
      ...
      {isExpanded && (
        <div className="mt-4 pt-4 border-t border-border flex flex-col gap-4">
          ...
          {!checking && deepseekStatus && !deepseekStatus.installed && (
            <ToolSetupAlert title="DeepSeek TUI not detected locally">
              <p className="text-sm text-text-muted w-full">Install via npm:</p>
              <code className="block p-2 bg-black/20 rounded text-xs font-mono w-full">npm install -g deepseek-tui</code>
              <p className="text-sm text-text-muted w-full">Manual configuration is still available if 9router is deployed on a remote server.</p>
