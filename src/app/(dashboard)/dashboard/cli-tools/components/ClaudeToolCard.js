...
import { Card, Button, ModelSelectModal, ManualConfigModal, Tooltip, ToolSetupAlert } from "@/shared/components";
        ...
        <div className="mt-4 pt-4 border-t border-border flex flex-col gap-4">
          ...
          {!checkingClaude && claudeStatus && !claudeStatus.installed && (
            <div className="flex flex-col gap-4">
              <ToolSetupAlert
                title="Claude CLI not detected locally"
                description="Manual configuration is still available if 9router is deployed on a remote server."
              >
