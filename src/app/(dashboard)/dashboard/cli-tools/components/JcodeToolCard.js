      ...
      {isExpanded && (
        <div className="mt-4 pt-4 border-t border-border flex flex-col gap-4">
          ...
          {!checkingJcode && jcodeStatus && !jcodeStatus.installed && (
            <ToolSetupAlert title="jcode CLI not detected locally">
              <p className="text-sm text-text-muted w-full">Install jcode to enable automatic configuration:</p>
              <code className="block p-2 bg-black/20 rounded text-xs font-mono w-full">
