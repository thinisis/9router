...
import { Card, Button, Modal, Input, ModelSelectModal, ConfirmModal, EmptyState, CapacityBadges, Select } from "@/shared/components";
    ...
    <div className="flex min-w-0 flex-col gap-6 px-1 sm:px-0">
      ...
      {loading ? (
        ...
        <EmptyState
          icon="layers"
          title="No combos yet"
          description="Add your first combo to chain models in priority order."
          action={{ label: "Create Combo", icon: "add", onClick: () => setShowCreateModal(true) }}
        />
      ) : (
